  ...
  return <div className="h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-180px)]">
        <div className="lg:col-span-1 overflow-y-auto pr-2 space-y-4">
          ...
          {filteredItems.length > 0 ? filteredItems.map(item => <MenuItemCard key={item.id} item={item} isSelected={selectedMenuItem && selectedMenuItem.id === item.id} onClick={() => setSelectedMenuItem(item)} onToggleAvailability={() => onUpdateMenuItem(item.id, {
