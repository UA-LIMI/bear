  ...
  return <div className="space-y-6">
      {sortedFloors.map(floor => <div key={floor}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {roomsByFloor[floor].map(room => <div key={room.roomNumber} className={`p-3 rounded-lg border ${room.status === 'occupied' ? 'border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/10' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50'}`}>
