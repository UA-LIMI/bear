...
export const GuestProfileDetail: React.FC<GuestProfileDetailProps> = ({
  ...
  const aiSummary = mockGuestAISummaries[guest.id];
      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 p-4">
                ...
                <ul className="space-y-2">
                  {guest.preferences.dining.map((pref, index) => <li key={index} className="flex items-center text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 p-4">
                ...
                <ul className="space-y-2">
                  {guest.preferences.activities.map((pref, index) => <li key={index} className="flex items-center text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 p-4">
                ...
                <ul className="space-y-2">
                  {guest.preferences.roomService.map((pref, index) => <li key={index} className="flex items-center text-gray-700 dark:text-gray-300">
        ...
        {activeTab === 'requests' && <div>
            ...
            <div className="space-y-4">
              {guest.requestHistory.map(request => <div key={request.id} className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 p-4">
          ...
          {aiInsights ? <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {aiInsights.preferences.map((pref, index) => <li key={index} className="flex items-start text-sm text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {aiInsights.recommendations.map((rec, index) => <div key={index} className="bg-white dark:bg-gray-700 p-3 rounded-lg border border-gray-200 dark:border-gray-600">
                      <div className="flex justify-between items-start">
              ...
              {aiInsights.specialAttention && <div>
                  ...
                  <ul className="space-y-1">
                    {aiInsights.specialAttention.map((point, index) => <li key={index} className="flex items-start text-sm text-gray-700 dark:text-gray-300">
