...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  const toggleSidebar = () => {
    ...
    return <div className="flex h-screen bg-gradient-to-br from-gray-600 to-gray-800 text-white relative overflow-hidden">
        ...
        {/* Sidebar - Hidden on large screens by default, toggle with menu button */}
        <div className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-800 backdrop-blur-md border-r border-white/10 ${sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'}`}>
