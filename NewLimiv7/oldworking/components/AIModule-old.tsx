              ...
              {!client?.connected ? (
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center space-y-6 max-w-md">
                    ...
                    <div>
                      <h3 className="text-white text-xl font-bold mb-2">Connect to LIMI AI</h3>
                      <p className="text-gray-300">Start voice chat with your AI assistant</p>
                    </div>
                    <ConnectButton
                      onConnect={async () => {
                      ...
                      className="w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-medium py-4 px-8 rounded-xl text-lg"
                    />
                  </div>
                </div>
              ) : (
                /* Connected - Show active AI interface */
                <>
                  {/* Audio Visualizers - Only when connected */}
                  ...
                  {/* Live Transcript Display - Only when connected */}
                  ...
                  <div className="flex justify-center">
                    <ConnectButton
                      ...
                      className="bg-red-500 hover:bg-red-600 text-white font-medium py-3 px-8 rounded-xl"
                    />
                  </div>
                </>
              )}
